...
export const products = [
  ...
  {name: 'The north coat', img: gamepad, price: 260, newPrice: 360, rating: 5, ratingNo: 65, discount: 0, status: '', colors: [], section: 'bestProduct'},
  {name: 'Gucci duffle bag', img: keyboard, price: 960, newPrice: 1160, rating: 4.5, ratingNo: 65, discount: 0, status: '', colors: [], section: 'bestProduct'},
  {name: 'RGB liquid CPU Cooler', img: monitor, price: 160, newPrice: 170, rating: 4.5, ratingNo: 65, discount: 0, status: '', colors: [], section: 'bestProduct'},
  {name: 'Small BookSelf', img: chair, price: 375, rating: 5, ratingNo: 65, discount: 0, status: '', colors: [], section: 'bestProduct'},
